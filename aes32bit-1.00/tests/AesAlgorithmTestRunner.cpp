 ...
 * File   : AesAlgorithmTestRunner.cpp
 * Author : Oliver Mueller <oliver@cogito-ergo-sum.org>
 * Purpose: Runner of CppUnit test of AES algorithm in class AesEncryption.
 *
 * $Id: AesAlgorithmTestRunner.cpp 18 2011-04-19 12:18:38Z oliver $
 *
